-- Comprehensive catch-all migration to ensure ALL schema columns exist on Railway.
-- Uses IF NOT EXISTS throughout so it's safe to re-run on any database state.
...
CREATE TABLE IF NOT EXISTS "JOLTSStateData" (
    "id" TEXT NOT NULL,
...
-- ============ RHAJReference table ============
CREATE TABLE IF NOT EXISTS "RHAJReference" (
    "id" TEXT NOT NULL,
